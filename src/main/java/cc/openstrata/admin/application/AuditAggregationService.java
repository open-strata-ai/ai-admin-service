...
import cc.openstrata.admin.infrastructure.persistence.AuditLogRepository;
...
public class AuditAggregationService {
    ...
    private AuditEntry toDomain(cc.openstrata.admin.infrastructure.persistence.AuditEntryEntity e) {
